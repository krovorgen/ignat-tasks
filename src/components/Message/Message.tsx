...
export const Message: FC<IMessageProps> = ({ avatar, name, message, time, type }) => {
  return (
      ...
      <div className={styles['message__inner']}>
        {type === 'GET' && (
          <>
            ...
            <div className={`${styles['message__info']} ${styles['message__info--get']}`}>
        ...
        {type === 'POST' && (
          <>
            <div className={`${styles['message__info']} ${styles['message__info--post']}`}>
              <p className={styles['message__author']}>{name}</p>
              <p className={styles['message__text']}>{message}</p>
              <span className={styles['message__time']}>{time}</span>
            </div>
