...
test('find text "test message name"', () => {
  const { getByText } = render(
    <Message avatar="" name="test message name" message="" time="" type="POST" />,
  );
...
test('find text "test message"', () => {
  const { getByText } = render(
    <Message avatar="" name="" message="test message" time="" type="POST" />,
  );
...
test('find text "test message time"', () => {
  const { getByText } = render(
    <Message avatar="" name="" message="" time="test message time" type="POST" />,
  );
